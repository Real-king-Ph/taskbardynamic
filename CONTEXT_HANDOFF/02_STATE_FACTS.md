...
- [F-018] [P1] [已确认] 仓库标签现状：本地与远端均已有 `v1.1`、`v1.2`、`v1.2.1`、`v1.2.2`；`v1.2.2` 指向 `4e0c900`。历史 `release` 标签与 `v1.0` Release 已被删除（那条「v1.0 附件实为 v1.1 DLL」的遗留问题以删除 v1.0 Release 收尾）。
